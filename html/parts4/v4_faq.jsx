...
const FAQS_V4 = [
  {
    ...
    a: 'If you are seeing recurring issues, manual workarounds, reporting delays or low adoption, it may be time to review what is causing friction.',
  },
  {
  ...
  },
  {
    ...
    a: 'Zeneesha reviews your Workday setup, processes, data, reporting, integrations and adoption to identify gaps, risks and optimisation opportunities.',
  },
];
    ...
    <section id="faq" className="relative py-28 bg-white overflow-hidden">
      <div className="max-w-[1440px] mx-auto px-8 grid lg:grid-cols-12 gap-16">
        ...
        <div className="lg:col-span-4 lg:sticky lg:top-28 self-start">
          ...
          <p className="reveal delay-2 mt-6 text-[18px] leading-[1.55] text-slate2 max-w-[340px]" style={{ fontWeight: 300 }}>
