...
const NavV4 = () => {
  ...
  const links = [
    ...
    { label: 'How We Help',  id: 'solutions'  },
      ...
      >
        <div className="max-w-[1440px] mx-auto px-6 md:px-8 h-[68px] md:h-[76px] flex items-center justify-between">
          ...
          <a href="#top" className="flex items-center gap-4 group">
            <LogoFull height={34} />
            <span className="hidden md:inline-block pl-3 border-l border-navy/20 text-[11px] tracking-[0.16em] uppercase text-navy/50 font-mono">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              href="#talk"
              className="hidden lg:inline-flex items-center gap-2 text-[15px] font-medium px-5 py-2.5 rounded-full bg-redorange text-white hover:bg-[#D63C23] transition-all duration-300 shadow-[0_8px_24px_-8px_rgba(232,71,44,0.5)]"
            >
        ...
        >
          <nav className="max-w-[1440px] mx-auto px-6 py-6 flex flex-col gap-1">
            ...
            <div className="mt-2 flex items-center justify-center gap-2 text-[11px] text-navy/40 font-mono tracking-[0.14em] uppercase">
              Workday Service Partner
            </div>
          </nav>
        </div>
