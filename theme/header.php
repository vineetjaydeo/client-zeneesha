...
<!-- ── Navigation ── -->
<?php
// Secondary pages always get a solid cream nav — logo doesn't work on dark backgrounds
$_tmpl = get_page_template_slug();
...
$_nav_solid = in_array( $_tmpl, $_secondary_templates );
?>
<header class="site-nav<?php echo $_nav_solid ? ' nav--solid' : ''; ?>" id="site-nav" role="banner">
  <div class="nav-inner">
    ...
    <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="nav-logo" aria-label="Zeneesha home">
      ...
      <span class="nav-logo-badge hidden-mobile">Workday Service Partner</span>
    </a>
  ...
  <div class="mobile-menu" id="mobile-menu" role="navigation" aria-label="Mobile navigation">
    <nav>
      ...
      <div class="booking-status" style="justify-content:center;margin-top:.75rem">
        <span class="status-dot"></span> Booking Q3 engagements
      </div>
    </nav>
  </div>
</header>
...
<a href="<?php echo esc_url( home_url( '/contact/' ) ); ?>" class="mobile-bottom-cta" aria-label="Book a consultation">
  Book a Consultation <?php echo z_arrow( 13 ); ?>
</a>
