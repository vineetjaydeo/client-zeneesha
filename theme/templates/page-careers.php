...
<!-- ════════════════════════════════════════════════════════════
     3 + 4. ROLES + FORM — 50/50 split
════════════════════════════════════════════════════════════ -->
<section id="careers-form" class="careers-split-section">
  <div class="container">
    <div class="careers-split-grid">

      <!-- LEFT — open roles ─────────────────────────────── -->
      <div class="careers-split-left">
        ...
        <p class="careers-speculative reveal delay-2">
          ...
          Speculative applications are always welcome &mdash; send us your CV.
        </p>

      </div><!-- /.careers-split-left -->

      <!-- RIGHT — CV form ───────────────────────────────── -->
      <div class="careers-split-right">

        <div class="careers-form-intro">
          <div class="section-label reveal">
            <span class="section-label-line" style="background:var(--navy)"></span>
            Send Us Your CV
          </div>
          ...
          <form id="careers-contact-form" class="form--light" enctype="multipart/form-data" novalidate>
            ...
            <div class="form-group">
              ...
              <label class="careers-file-wrap" for="careers_cv">
                ...
                <span class="careers-file-hint">or drag &amp; drop here</span>
              </label>
      ...
      </div><!-- /.careers-split-right -->

    </div><!-- /.careers-split-grid -->
  </div>
</section>
