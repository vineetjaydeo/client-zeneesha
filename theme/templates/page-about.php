...
// ── Unsplash image pool ────────────────────────────────────────────────────
// All photos are free-to-use via Unsplash license.
$img_base = 'https://images.unsplash.com/';
$img = [
    'hero'    => $img_base . 'photo-1522071820081-009f0129c71c?w=900&q=75&auto=format&fit=crop',   // team collaborating
    'story'   => $img_base . 'photo-1486325212027-8081e485255e?w=800&q=75&auto=format&fit=crop',   // London Canary Wharf
    'mission' => $img_base . 'photo-1600880292203-757bb62b4baf?w=700&q=75&auto=format&fit=crop',   // diverse professional team
];
...
<script type="application/ld+json">
{
  ...
  "itemListElement":[
    ...
    {"@type":"ListItem","position":2,"name":"About","item":"<?php echo esc_url(get_permalink()); ?>"}
  ]
}
</script>
...
<!-- ════════════════════════════════════════════════════════════
     1. HERO
════════════════════════════════════════════════════════════ -->
<section class="page-hero-fullbg about-hero">
  <img
    src="<?php echo esc_url( $img['hero'] ); ?>"
...
<!-- Credentials bar -->
<div class="about-creds-bar">
  <div class="container">
    <div class="about-creds-inner">
      <div class="about-cred-item">
        <span class="about-cred-label">Founded</span>
        <span class="about-cred-val">2015 &mdash; London, UK</span>
      </div>
      <div class="about-cred-sep" aria-hidden="true"></div>
      <div class="about-cred-item">
        <span class="about-cred-label">Reg. No.</span>
        <span class="about-cred-val">09579625</span>
      </div>
      <div class="about-cred-sep" aria-hidden="true"></div>
      <div class="about-cred-item">
        <span class="about-cred-label">Partner Status</span>
        <span class="about-cred-val">Workday Sales &amp; Services Partner</span>
      </div>
      <div class="about-cred-sep" aria-hidden="true"></div>
      <div class="about-cred-item">
        <span class="about-cred-label">Certification</span>
        <span class="about-cred-val">Cyber Essentials Certified</span>
      </div>
      <div class="about-cred-sep" aria-hidden="true"></div>
      <div class="about-cred-item">
        <span class="about-cred-label">Coverage</span>
        <span class="about-cred-val">UK HQ &mdash; EMEA delivery</span>
      </div>
    </div>
  </div>
</div>
...
<section class="about-mission-section">
  <div class="container">
    <div class="about-mission-split">
      ...
      <!-- Left: heading + body + value pills -->
      <div class="about-mission-left">
        <div class="section-label reveal">
          <span class="section-label-line" style="background:var(--navy)"></span>
          Our Mission
        </div>
        <h2 class="about-mission-heading reveal delay-1">Every Organisation, Fully Realising Their Workday Investment</h2>
        <p class="about-mission-body reveal delay-2"><?php echo esc_html( $mission ); ?></p>
        <div class="about-mission-pills reveal delay-3">
      ...
      <!-- Right: image only -->
      <div class="about-mission-right reveal delay-2">
        <img
          src="<?php echo esc_url( $img['mission'] ); ?>"
          class="about-mission-img"
          alt="Zeneesha professionals working together"
  ...
  <div class="container">
    <div class="about-story-inner">
      ...
      <div class="about-story-label-col">
        <div class="about-story-img-wrap reveal delay-2">
          <img
            src="<?php echo esc_url( $img['story'] ); ?>"
            alt="Zeneesha — London-based Workday practice"
      ...
      <div class="about-story-text-col">
        ...
        <h2 class="about-story-heading reveal delay-1">Built by Practitioners. Built for Partnership.</h2>
...
<section id="directors" class="about-directors-section">
  <div class="container">
    ...
    <div class="about-directors-intro">
      ...
      <h2 class="about-directors-heading reveal delay-1">The People Behind Zeneesha</h2>
...
<section class="about-values-section">
  <div class="container">
    ...
    <div class="about-values-intro">
      ...
      <h2 class="about-values-heading reveal delay-1">Six Principles That Shape Every Engagement</h2>
